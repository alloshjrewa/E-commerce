            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right ">
                        <a href='<?php echo e(url('admin/product/create')); ?>' class="btn btn-primary">Add New
                            Products</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $getRecord; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='<?php echo e(url('admin/product/edit/' . $value->id)); ?>'
                                                        class="btn btn-info btn-sm">Edit</a>
                                                    <a href='<?php echo e(url('admin/product/delete/' . $value->id)); ?>'
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/admin/product/index.blade.php ENDPATH**/ ?>