            ...
            <div class="container">
                                        ...
                                        <figure class="slide-image"  >
                                            <picture >
                                                <source media="(max-width: 480px)"
                                                    srcset="<?php echo e($slider->getImage()); ?>">
                            ...
                            <div class="row row-sm">
                                <div class="col-md-6 col-lg-12">
                                    <div class="banner banner-display">
                                        <a href="#">
                                            <img src="<?php echo e(url('assets/images/sport.jpeg')); ?>" style="height:275px" alt="Banner">
                                        </a>
                                ...
                                <div class="col-md-6 col-lg-12">
                                    <div class="banner banner-display mb-0">
                                        <a href="#">
                                            <img src="<?php echo e(url('assets/images/slipper.jpeg')); ?>" style="height:230px" alt="Banner">
                                        </a>
                ...
                <div class="owl-carousel owl-simple" data-toggle="owl"
                    ...
                    "responsive": {
                        ...
                        <a href="<?php echo e(!empty($partner->link) ? $partner->link : '#'); ?>" class="brand">
            ...
            <div class="row">
                <div class="col-6 col-lg-4">
                    <div class="banner banner-display banner-link-anim">
                        <a href="<?php echo e(url('/men-shoes')); ?>">
                            <img src="<?php echo e(url('assets/images/banner/men.jpeg')); ?>" style="height:100%" alt="Banner">
                        </a>

                        <div class="banner-content banner-content-center">
                            <h3 class="banner-title text-white"><a href="#">Men</a></h3>

                            <a href="<?php echo e(url('/men-shoes')); ?>" class="btn btn-outline-white banner-link">Shop Now<i
                                    class="icon-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-4 order-lg-last">
                    <div class="banner banner-display banner-link-anim">
                        <a href="<?php echo e(url('/women-shoes')); ?>">
                            <img src="<?php echo e(url('assets/images/banner/women.jpeg')); ?>" alt="Banner">
                        </a>

                        <div class="banner-content banner-content-center">
                            <h3 class="banner-title text-white"><a href="#">Women</a></h3>

                            <a href="<?php echo e(url('/women-shoes')); ?>" class="btn btn-outline-white banner-link">Shop Now<i
                                    class="icon-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-lg-4 banners-sm">
                    <div class="row">
                        <div class="banner banner-display banner-link-anim col-lg-12 col-6">
                            <a href="<?php echo e(url('/kids-shoes')); ?>">
                                <img src="<?php echo e(url('assets/images/banner/kids.jpeg')); ?>" alt="Banner">
                            </a>

                            <div class="banner-content banner-content-center">
                                <h3 class="banner-title text-white"><a href="#">Kids</a>
                                </h3>
                                <a href="<?php echo e(url('/kids-shoes')); ?>" class="btn btn-outline-white banner-link">Shop Now<i
                                        class="icon-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/home.blade.php ENDPATH**/ ?>